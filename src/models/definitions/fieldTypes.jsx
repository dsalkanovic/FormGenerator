...
export const FiledTypes = {
    ...
    Number: { name: 'FT_NUMBER', labe: 'Number', buildDefinition: d => new TextFieldDefinition(d), icon: Hash, rank: 100 },
    Select: { name: 'FT_SELECT', labe: 'Select', buildDefinition: d => new TextFieldDefinition(d), icon: List, rank: 100 },
    Boolean: { name: 'FT_BOOLEAN', labe: 'Checkbox', buildDefinition: d => new TextFieldDefinition(d), icon: ToggleLeft, rank: 100 },
    Date: { name: 'FT_DATE', labe: 'Date', buildDefinition: d => new TextFieldDefinition(d), icon: Calendar, rank: 100 },
